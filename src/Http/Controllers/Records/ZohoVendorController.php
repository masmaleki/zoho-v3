...
class ZohoVendorController
{
    ...
    public static function getAll($page_token = null,$fields=null)
    {
        ...
        if($fields==null){
            $fields='Email,Fax_Number,Business_Vendor,Vendor_Source,Vendor_Type,LinkedIn,Website,Mobile,Phone,Vendor_Name,Country,First_Name,Last_Name,ZohoBooksID,Octopart_ID,Broker_Type,Vendor_Site,Vendor_Owner,Zip_Code,Street,State,Description,City,Vendor_Image,VAT_No,Modified_By,Approve_status,Approved_By,Contracts,Created_By,Currency,Forwarder,Incoterms,Forwarder_Account_no.,Layout,Line_Card,Parent_Vendor,Payment_Terms,Vendor_Number';
        }
