 ...
 * @method static mixed getInvoicePDF(int $invoice_id)
 * @method static mixed getInvoiceHTML(int $invoice_id)
 ...
 * @method static mixed getPurchaseOrderPDF(int $sale_order_id)
